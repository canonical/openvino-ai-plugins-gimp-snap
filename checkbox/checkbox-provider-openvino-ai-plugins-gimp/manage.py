...
setup(
    name='com.canonical.certification:openvino-ai-plugins-gimp',
    version="1.0",
    description=N_("The com.canonical.certification:openvino-ai-plugins-gimp provider"),
    gettext_domain="com_canonical_certification_openvino_ai_plugins_gimp",
)
